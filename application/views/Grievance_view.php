            ...
            <div class="row">
              ...
              <div class="col-lg-4 col-md-5 col-sm-12">
                ...
                <div class="card card_custom">
                  ...
                  <form action="<?php echo base_url(); ?>grievance/gform" method="post">
                    <div class="form-group">
                      <h5 class="center-align">Affiliation</h5>
                      <select class="custom-select">
                        <option selected="" value=" "><strong>I am a ..</strong></option>
                      ...
                      <input type="text" class="form-control" placeholder="16us31" id="id_rollno">
                      <label class="col-form-label" for="inputDefault">Name</label>
                      <input type="text" class="form-control" placeholder="John Doe" id="id_name">
                      <label class="col-form-label" for="inputDefault">Father's Name</label>
                      <input type="text" class="form-control" placeholder="Doe" id="id_fname">
                      <label class="col-form-label" for="inputDefault">Date of birth</label>
                      <input type="text" class="form-control" placeholder="DD/MM/YYYY" id="id_dob"><br>
                      <div style="text-align:center;">
                        <input type="submit" style="text-align:center;"class="btn btn-info" value="Proceed">
                      </div>
                    </div>
                  </form>
              </div>
